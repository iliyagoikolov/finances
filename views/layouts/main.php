...
<div class="wrap">
    ...
    NavBar::begin([
        ...
        'brandLabel' => Html::img("@web/images/logo.png", ["class"=>"logo"])."<span class='navbar-text'>".Yii::$app->name."</span>",
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            Yii::$app->user->isGuest ? (
                ...
                . Html::submitButton(
                    'Logout (' . Yii::$app->user->identity->first_name . ')', // changed username to first_name
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; Ilya Goikolov <?= date('Y') ?></p>
